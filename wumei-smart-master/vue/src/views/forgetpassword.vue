  ...
  <div class="forgetpassword">
    <el-form ref="registerForm" :model="registerForm" :rules="registerRules" class="register-form">
      ...
      <el-form-item prop="email">
        <el-input v-model="registerForm.email" placeholder="请输入邮箱" show-word-limit clearable
      ...
      <el-form-item style="width:100%;">
        ...
        <div style="float: right;">
          <router-link class="link-type" :to="'/login'">返回登录页面</router-link>
        </div>
      </el-form-item>
    </el-form>
    <!--  底部  -->
    <div class="el-register-footer">
      <span>Copyright © ahnu.</span>
    </div>
  </div>
</template>
    ...
    methods: {
      ...
      handleforgetpassword() {
        this.$refs.registerForm.validate(valid => {
          if (valid) {
            this.loading = true;
            forgetpassword(this.registerForm).then(res => {
              const username = this.registerForm.userName;
              this.$alert("<font color='red'>恭喜你，您的账号 " + username + " 密码修改成功！</font>", '系统提示', {
